      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Button size="sm" className="bg-red-600 hover:bg-red-700 flex items-center space-x-2">
            ...
            <div className="space-y-4">
              {navItems.map((item) => (
                <a
                  key={item.name}
                  href={item.href}
                  className="flex items-center space-x-3 px-4 py-2 text-gray-700 hover:text-red-600 hover:bg-gray-50 rounded-lg transition-colors duration-200"
              ...
              <div className="px-4 pt-4 border-t border-gray-200 space-y-2">
                ...
                <Button className="w-full bg-red-600 hover:bg-red-700 flex items-center space-x-2">
                  <UserPlus className="h-4 w-4" />
                  <span>Sign Up</span>
                </Button>
              </div>
